# Variables for Anyscale Cloud Configuration
# ---------------------------------------------------------------------------------------------------------------------
# REQUIRED VARIABLES
...
#   description = "The credentials for the cloud provider (e.g., IAM role ARN for AWS)"
#   type        = string
#   sensitive   = true
# }
...
variable "existing_cloud_id" {
  description = "The ID of an existing Anyscale cloud to retrieve (optional)"
  type        = string
  default     = null
}
