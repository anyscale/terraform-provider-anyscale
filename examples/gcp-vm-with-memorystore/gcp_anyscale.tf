# GCP with Memorystore Scenario - Cloud Foundation Module
...
module "google_anyscale_v2" {
  ...
  anyscale_vpc_public_subnet_cidr               = "10.102.0.0/16"
  ...
  # Filestore: DISABLED for this scenario
  enable_anyscale_filestore = false

  # Memorystore: ENABLED for this scenario
